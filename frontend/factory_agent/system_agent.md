...
Both prompts are stored here as the single source of truth. When updating a prompt, update it here first, then sync the change to the corresponding route file.
